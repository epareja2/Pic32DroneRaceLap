...
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc="DRV_TOUCH_ADS7843 Initialization Data">
/*** ADS7843 Driver Initialization Data ***/

const DRV_TOUCH_INIT drvAds7843InitData =
{
    .moduleInit           = {0},
...
{
    .drvInitialize           = DRV_TOUCH_ADS7843_Initialize,
    .drvOpen                 = DRV_TOUCH_ADS7843_Open,
    .drvTouchStatus          = DRV_TOUCH_ADS7843_TouchStatus,
    .drvTouchDataRead        = DRV_TOUCH_ADS7843_TouchDataRead,
    .drvCalibrationSet       = DRV_TOUCH_ADS7843_CalibrationSet,
    .drvTouchGetX            = DRV_TOUCH_ADS7843_TouchGetX,
    .drvTouchGetY            = DRV_TOUCH_ADS7843_TouchGetY,
    .drvTouchPenGet          = DRV_TOUCH_ADS7843_TouchPenGet,
    .orientation             = 0,
...
void SYS_Initialize ( void* data )
{
  ...
  /* Initialize the ADS7843 Touch Driver Object  */
  sysObj.drvAds7843 = DRV_TOUCH_ADS7843_Initialize(DRV_TOUCH_INDEX_0, (SYS_MODULE_INIT *)&drvAds7843InitData);
